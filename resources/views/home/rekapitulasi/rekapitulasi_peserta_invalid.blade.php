...
<div class="row" align="center">
    <div class="col-lg-12">
      <h2><b>DAFTAR PESERTA TIDAK LOLOS VERIFIKASI KAFILAH {{ strtoupper($nama_kafilah)}}</b></h2>
    </div>
  </div>
<div class="row">
    <div class="col-lg-12">
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h5>Daftar Peserta Tidak Lolos Verifikasi Kafilah {{$nama_kafilah}} </h5>
        ...
        <div class="ibox-content">
              {!! Form::open(['url' => 'operator_registrasi/rekapitulasi_peserta_invalid/filter',  'class' => 'form-horizontal']) !!}
